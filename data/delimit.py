...
if __name__ == "__main__":
    parser = OptionParser()
    parser.add_option("-i", "--infile", dest="infilename", help="The file you want to delimit")
    parser.add_option("-o", "--outfile", dest="outfilename", help="The newly delimited data")
    parser.add_option("-l", "--learnwith", dest="learn_with", default=" ",
                      help="The character you want check as a potential delimiter. example -l \" \". quotes are ignored")
    parser.add_option("-d", "--delimiter", dest="delimiter", help="The new delimiter")
